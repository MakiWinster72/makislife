...
![](https://img.makis-life.cn/images/20260109114343323.png)
才 10W！！！win 你就是给我待机都要十几瓦了，动动就二十来瓦了。。。
...
④ **配合桌面管理器（Display Manager）**  
如果你用的是 **Hyprland** + TTY 登录，几乎不需要特别设置。  
如果你用 **GDM / SDDM / LightDM**，可指定：
