      ...
      children: [
        {
          ...
          readingTime: "2 分钟",
          tags: ["Mysql", "Windows"],
          contentFile: "./techBlogs/windows/mysql80.md",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          readingTime: "1 分钟",
          tags: ["工具"],
          contentFile: "./techBlogs/tools/resetCursor.md",
        },
        {
          type: "article",
          id: "thinking-2",
          ...
          readingTime: "2 分钟",
          tags: ["工具"],
          contentFile: "./techBlogs/tools/smartInput.md",
        },
      ],
    },
    {
      ...
      children: [
        {
          ...
          readingTime: "8 分钟",
          tags: ["教程"],
          contentFile: "./techBlogs/guide/deploy_ssl_nginx.md",
        },
      ],
    },
  ],
